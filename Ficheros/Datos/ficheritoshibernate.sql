...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-12-2018 a las 21:10:04
...
--
-- Base de datos: `ficheritoshibernate`
--
...
(1, 'gfasdhjfds', 'sgdf', 1, '2000-10-10');
...
ALTER TABLE `ficheritos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `Empresa_2` (`Empresa`),
  ADD KEY `Empresa_3` (`Empresa`);
