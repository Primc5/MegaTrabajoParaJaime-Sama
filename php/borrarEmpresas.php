...
require 'jsonEsperandoBorrarEmpresa.php';
/*
...
if(isset($parameters)){
	...
	if(JSONCorrectoBorrarEmpresa($mensajeRecibido)){
		$empresa = $mensajeRecibido["EmpresaBorrar"];
		$id = $empresa["id_Empresa"];
		$query  = "DELETE FROM empresas WHERE id_Empresa = $id";
		$result2 = $conn->query ( $query );
		if (isset ( $result2 ) && $result2) {
			$arrMensaje["estado"] = "ok";
			$arrMensaje["mensaje"] = "Empresa borrado correctamente";
