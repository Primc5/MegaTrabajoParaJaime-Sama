...
if(isset($parameters)){
	...
	if(JSONCorrectoAnnadir($mensajeRecibido)){
		...
		$creacion = $juego["Creacion"];

		$query  = "INSERT INTO  ficheritos (nombre,tipo,Empresa,Creacion) ";
		$query .= "VALUES ('$nombre','$tipo',$empresa,'$creacion')";
