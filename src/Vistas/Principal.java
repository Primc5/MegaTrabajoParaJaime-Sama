...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		txtpnEscribeElFeedback.setText(
				"Realizar operaciones del fichero como ver el contenido, a\u00F1adir datos o pasar la informaci\u00F3n del fichero a la base de datos");
		...
		txtpnEstoEsUn.setText(
				"Realizar operaciones de la base de datos como ver el contenido, a\u00F1adir datos o pasar la informaci\u00F3n de la base de datos  al fichero");
